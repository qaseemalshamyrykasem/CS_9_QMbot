...
إن كان لديكم ملخصات أو ملفات متعلقة بالمنهج، وتحب أن تشاركها في البوت.
تواصل مع مطور البوت:
"@DEV_QM"

لإبداء آرائكم واقتراحاتكم، تواصل معنا،،

يسعدنا دومًا أن تشاركنا رأيك 😇
✨ ::::::::::::::::::::::::::::::::::::::::::::::::✨
`;
...
const channels = {
    '🖥️ علوم الحاسوب': {
        '📚 السنة الأولى': {
            '📖 الفصل الأول': {
                '📐 رياضيات': {
                    '📘 د. مالك الجبري': '@math_malek_channel',
